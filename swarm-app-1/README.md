...
docker service create --name vote -p 80:80 --network backend --replicas 2 dockersamples/examplevotingapp_vote:before
...
docker service create --name rediss -p 80:80 --network backend --replicas 1 redis:3.2
